...
${OBJECTDIR}/libcomm/uart.o: libcomm/uart.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__AVR_ATmega328P__ -I../includes -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libcomm/uart.o libcomm/uart.cpp

${OBJECTDIR}/sources/main.o: sources/main.cpp
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__AVR_ATmega328P__ -I../includes -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/main.o sources/main.cpp
