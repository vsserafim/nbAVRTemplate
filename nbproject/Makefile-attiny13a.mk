...
${CND_DISTDIR}/${CND_CONF}/nbAVRTemplate.elf: ${OBJECTFILES}
	...
	avr-gcc -o ${CND_DISTDIR}/${CND_CONF}/nbAVRTemplate.elf ${OBJECTFILES} ${LDLIBSOPTIONS} -Os -Wl,--gc-sections -lm -mmcu=attiny13

${OBJECTDIR}/libcomm/uart.o: libcomm/uart.cpp
	${MKDIR} -p ${OBJECTDIR}/libcomm
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__AVR_ATtiny13A__ -I../includes -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libcomm/uart.o libcomm/uart.cpp

${OBJECTDIR}/sources/main.o: sources/main.cpp
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D__AVR_ATtiny13A__ -I../includes -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/main.o sources/main.cpp
